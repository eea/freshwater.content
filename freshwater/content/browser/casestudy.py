...
class SetupCaseStudies(BrowserView):
    ...
    def __call__(self):
        ...
        for index, case_study in enumerate(case_studies):
            ...
            soup_case_study = BeautifulSoup(page_case_study.content, "html.parser")
            ...
            try:
                ...
                general = self.get_section_by_id(soup_case_study, 'edit-group-general')
                site_info = self.get_section_by_id(soup_case_study, 'edit-group-site-information')
                monitoring_maintenance = self.get_section_by_id(soup_case_study, 'edit-group-monitoring-maintenance')
                performance = self.get_section_by_id(soup_case_study, 'edit-group-performance')
                design_implementations = self.get_section_by_id(soup_case_study, 'edit-group-design-implementations')
                lessons_risks = self.get_section_by_id(soup_case_study, 'edit-group-lessons-risks-implications')
                policy_general_gov = self.get_section_by_id(soup_case_study, 'edit-group-policy-general-governance-')
                socio_economic = self.get_section_by_id(soup_case_study, 'edit-group-socio-economic')
                biophysical_impacts = self.get_section_by_id(soup_case_study, 'edit-group-biophysical-impacts')
            except:
                import pdb; pdb.set_trace()
